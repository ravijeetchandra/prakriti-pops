...
export default function HomePage() {
  ...
  return (
    <div className="bg-cream">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="z-10">
              ...
              <motion.h1
                ...
                className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold leading-[1.1] mb-6"
              >
                {t('home.hero_title')}
              ...
              <motion.p
                ...
                className="text-lg md:text-xl text-white/80 max-w-lg leading-relaxed mb-10 font-light"
              >
            ...
            >
              <div className="relative z-10">
                ...
                <div className="absolute -top-6 -left-6 bg-white text-secondary px-6 py-3 rounded-2xl shadow-xl text-sm font-bold whitespace-nowrap animate-float">
                  🔥 BOHOT HARDD
                </div>
                <div className="absolute -bottom-6 -right-6 bg-accent text-white px-6 py-3 rounded-2xl shadow-xl text-sm font-bold whitespace-nowrap animate-float" style={{ animationDelay: '1s' }}>
                  🧡 Bihar Ka Pride
                </div>
                <div className="absolute top-1/2 -right-10 bg-white text-foreground px-4 py-2 rounded-full shadow-lg text-xs font-bold animate-float" style={{ animationDelay: '2s' }}>
                  ⭐ 4.9 (500+ reviews)
                </div>
              </div>
      ...
      {/* Marquee Tagline Bar */}
      <div className="bg-primary py-3 overflow-hidden relative shadow-inner">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Link href="/about">
                <Button variant="outline" className="mt-4 px-8 py-3 rounded-full border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300">
                  Read Full Story →
                </Button>
              </Link>
            </motion.div>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-4">
            {campaigns.map((c) => (
              <div
                key={c.id}
                className="flex items-center gap-4 bg-gradient-to-r from-secondary to-secondary-dark text-white rounded-2xl px-6 py-4 shadow-lg hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <p className="text-muted text-lg">Sabse zyada bikne wale flavors 🔥</p>
            </div>
            <Link href="/shop" className="inline-flex items-center gap-2 text-sm font-bold text-primary hover:text-primary-dark transition-colors uppercase tracking-widest">
              {t('shop.title')} <span className="group-hover:translate-x-1 transition-transform">→</span>
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="text-foreground text-base leading-relaxed mb-6 italic font-light">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {[
              ...
              >
                <div className="w-20 h-20 rounded-3xl bg-primary/5 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-primary/10 transition-all duration-300">
